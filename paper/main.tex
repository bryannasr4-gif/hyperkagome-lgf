...
modular at level thirty, which supplies the closed form Varma and Monien sought. Its
...
method of differential approximants~\cite{Guttmann2010,orealgebra} returns an operator $L_4$ of order four and
degree fifteen.
...
made precise under \emph{Certification} below. Its leading coefficient factorizes as
\begin{equation}
...
$G_M$-irreducible); by the Lie--Kolchin theorem the irreducible representations of a connected solvable group are
...
operator of the modular curve $X(\Gamma_0(30)^+)$, its mirror map at the maximally unipotent point $t=0$ (see below) is the level-30
...
numbers~\cite{Beukers1987}---though, as Section~\ref{sec:y0closed} shows, a \emph{depth-one quasimodular} one
...
\bibitem{AbdelazizKoutschanMaillard2017} Y.~Abdelaziz, C.~Koutschan, and J.-M.~Maillard, Schwarzian conditions for linear differential operators with selected differential Galois groups. \textit{J. Phys. A: Math. Theor.} \textbf{50} (2017), 465201; arXiv:1706.07423.
