...
\author{Jean-Marie Maillard}
\affiliation{LPTMC, UMR 7600 CNRS, Sorbonne Universit\'e, 4 Place Jussieu, 75252 Paris Cedex 05, France}
\date{\today}
...
converts agreement of exact rational $q$-expansions through order $80$ into an identity. The hyperkagome LGF is
...
explicit order-two intertwiner realising it are certified in exact arithmetic in the accompanying repository.}
\begin{equation}
...
coordinates.%
% TODO(Bryan): decide whether the explicit V2, the conic point, and the bridge identity enter this paper in full or a companion analysis.
...
\footnote{The recombination ($yy_2=y_2-\tfrac{13}{30}\,y_1$ in the natural rescaling) is verified exactly, term by term and through the identity
...
rational function has equal degrees of zeros and poles, and $80>21$; hence $D\equiv0$. \hfill$\square$
...
at $t=\tfrac19$ whereas $R(t)\,W$ has half-integer order for every rational $R$. In fact the exclusion is categorical: no
...
independent of the differential-Galois certificate and is re-verified in exact
...
\bibitem{AVM2016} M.~Assis, M.~van Hoeij, and J.-M.~Maillard, J.\ Phys.\ A: Math.\ Theor.\ \textbf{49}, 214002 (2016); arXiv:1602.00868.
...
\bibitem{BoukraaHassaniMaillard2014} S.~Boukraa, S.~Hassani, J.-M.~Maillard, and J.-A.~Weil, J.\ Phys.\ A: Math.\ Theor.\ \textbf{47}, 095203 (2014); arXiv:1311.2470.
