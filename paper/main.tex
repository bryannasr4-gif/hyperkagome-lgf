...
\label{eq:schwarz}
\end{equation}
holds exactly~\cite{AbdelazizMaillard2016}. Equivalently: the ratio of two solutions of $w''+Q_Vw=0$ inverts the Hauptmodul, $V_2$ is the
...
\bibitem{AbdelazizMaillard2016} Y.~Abdelaziz and J.-M.~Maillard, ``Modular forms, Schwarzian conditions, and symmetries of differential equations in physics,'' J.\ Phys.\ A: Math.\ Theor.\ \textbf{49}, 215203 (2016).
\end{thebibliography}
